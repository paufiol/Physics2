...
bool ModuleSceneIntro::Start()
{
	...
	for (int n = 0; n < SnakeLength; n++)
	{
		...
		if (tmp != nullptr) {
			...
			//App->physics->AddConstraintP2P(*s, *tmp, btVector3(-Size, 0.f, 0.f), btVector3(Size, 0.f, 0.f));
			App->physics->AddConstraintHinge(*s, *tmp, btVector3(-Size, 0.f, 0.f), btVector3(Size, 0.f, 0.f), btVector3(0.0f, 1.0f, 0.0f), btVector3(0.0f, 1.0f, 0.0f));
		}
		tmp = s;
